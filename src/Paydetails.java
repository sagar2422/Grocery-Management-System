...
public class Paydetails extends javax.swing.JFrame {
       ...
       initComponents();
        try {
            ...
            while(rs.next()){
                ...
                String street = rs.getString("Card_no");
                String city = rs.getString("total");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Card No.", "Amount Payed"
            }
        ));
        jScrollPane1.setViewportView(jTable1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, -1, 350));
